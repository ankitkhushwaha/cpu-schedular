CC = gcc
CFLAGS = -Wall -g -Isrc -Ischedule_algorithms -Ischedule_algorithms/fifo  -Ischedule_algorithms/sjf -Ischedule_algorithms/srtf -Ischedule_algorithms/rr -fsanitize=thread -DNDEBUG
...
run: $(TARGET)
	TSAN_OPTIONS=second_deadlock_stack=1 ./$(TARGET) $(ALGO) $(INPUT)
