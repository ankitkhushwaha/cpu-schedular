...
void init_fcfs_th() {
    ...
    thread_core->add_to_waitQueue_core = add_to_waitQueue_fifo;
    thread_core->add_to_taskList_core = add_to_taskList_fifo;
    thread_core->remove_from_readyQueue_core = remove_from_readyQueue_fifo;
    thread_core->remove_from_waitQueue_core = remove_from_waitQueue_fifo;
    thread_core->remove_node_by_pid_core = remove_node_by_pid_t_fifo;
...
process_t *remove_node_by_pid_t_fifo(Queue *queue, int pid, pthread_mutex_t *mutex) {
